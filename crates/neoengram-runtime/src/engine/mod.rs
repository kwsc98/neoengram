...
pub use neoengram_domain::core::IndexMutation;
pub use ports::{
    Clock, ContentAddressedObject, DirectoryMetadata, FailureInjector, FailurePoint,
    FileFingerprint, FileRecord, ImmutableCatalogReader, IndexSnapshotReader, IndexVersion,
    JournalStore, LockManager, ManifestMetadata, MutationGuard, NoopFailureInjector,
