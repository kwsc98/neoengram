...
impl From<neoengram_domain::core::ValidationError> for EngineError {
    fn from(error: neoengram_domain::core::ValidationError) -> Self {
        let code = match error.kind() {
            neoengram_domain::core::ValidationErrorKind::InvalidPath => ErrorCode::InvalidPath,
            neoengram_domain::core::ValidationErrorKind::InvalidDigest
            | neoengram_domain::core::ValidationErrorKind::InvalidObject
            | neoengram_domain::core::ValidationErrorKind::InvalidManifest
            | neoengram_domain::core::ValidationErrorKind::InvalidDirectory
            | neoengram_domain::core::ValidationErrorKind::InvalidCommit
            | neoengram_domain::core::ValidationErrorKind::InvalidPublication
            | neoengram_domain::core::ValidationErrorKind::InvalidIndex
            | neoengram_domain::core::ValidationErrorKind::Overflow => ErrorCode::InvalidArgument,
