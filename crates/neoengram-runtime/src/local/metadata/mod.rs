...
//!
//! File payloads live in `ObjectStore`. The mutable WorkspaceIndex refers to immutable file Manifests,
...
pub(crate) use neoengram_domain::core::IndexVersion;
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct RepositoryConfigRecord {
...
///
/// Keeping this as a pure composition trait lets callers depend on the narrow local ports while
/// the repository object carries one storage implementation.
