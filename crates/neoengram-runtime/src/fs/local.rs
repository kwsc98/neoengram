...
use fs2::FileExt;
use neoengram_domain::core::{LogicalPath, PathComponent};
use tempfile::NamedTempFile;

use super::{io_error, rename_no_replace, sync_directory, VerifiedRoot};
...
mod tests {
    ...
    use crate::engine::{IndexVersion, JournalPhase};
