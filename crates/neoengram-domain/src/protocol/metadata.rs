...
impl MetadataPublication {
    ...
    pub fn from_pages(pages: &[MetadataBatchPage]) -> ProtocolResult<Self> {
        ...
        crate::core::validate_index_mutation_paths(index_mutations.iter().map(IndexMutation::path))
            .map_err(|error| invalid_publication(error.to_string()))?;
    ...
    pub fn publication_digest(
        ...
        .map_err(|error| invalid_publication(error.to_string()))?;
        crate::core::canonical::add_publication_digest(
...
mod tests {
    ...
    #[test]
    fn metadata_runtime_rejects_non_current_schema_versions() {
    ...
    #[test]
    fn page_rejects_unknown_extension_members() {
