...
impl AddPublicationFixture {
    ...
    fn digest(&self) -> Result<ContentDigest, neoengram_domain::core::ValidationError> {
...
fn index_v8_digest_and_delta_are_canonical() -> Result<(), Box<dyn std::error::Error>> {
    assert_eq!(WORKSPACE_INDEX_FORMAT_VERSION, 9);
    let manifest_id = empty_manifest().canonical_id()?;
    let records = vec![
    ...
    assert_eq!(
        ...
        "a03b6b7aab54c149a08e126bdd324a4088f248c609140e432be0c54576dc66fd"
    );
    ...
    assert_eq!(
        ...
        "91a964e71b339dd15777751dba0d26fe2d190f578f63a5dbb54a9c5e7c414dd0"
    );
    Ok(())
}
...
fn index_delta_pages_arbitrary_mutation_sequences_without_changing_identity(
    ...
    assert_eq!(
        delta.canonical_digest()?.to_string(),
        "5e0e9f49aa7369a00200002acfc0e6ac79d259081f7396347160bc234bbe6e82"
    );
