...
use neoengram_protocol::{
    ...
    EdgeClusterId, Extensions, GatewayConnectionId, GatewayControlFrame, GatewayControlMessage,
    GatewayOpaqueBytes, GatewayPeerDirectory, GatewayPeerDirectoryEntry, GatewayPeerForwardRequest,
    GatewayPoolId, GatewayReplicaId, GatewayRouteLeaseRequest, Generation, MessageId, RequestId,
    RouteGeneration, SequenceNumber, SessionGeneration, UnixMillis, PROTOCOL_VERSION_V1,
};
use serde_json::json;
    ...
    let frame = GatewayControlFrame {
        ...
        message: GatewayControlMessage::PeerDirectory(GatewayPeerDirectory {
            ...
            replicas: vec![GatewayPeerDirectoryEntry {
                gateway_replica_id: GatewayReplicaId::new("gateway-replica-2").unwrap(),
                certificate_generation: neoengram_protocol::CertificateGeneration::new(4),
                certificate_fingerprint: neoengram_protocol::ContentDigest::hash(
