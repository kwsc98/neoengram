use neoengram_central::{
    canonical_commit_id_with_layout, AddJobSpec, AuthorityStore, CentralErrorCode, CommitRecord,
    InMemoryComponents, JobOperation, JobRecord, PreCommitCancelRequest, PreCommitCommitRequest,
    PreCommitId, PreCommitKey, PreCommitRestartRequest, PreCommitStartRequest, PreCommitState,
    PublishedIndex,
};
...
async fn exercise_missing_frozen_head(
    repository: &dyn neoengram_central::PreCommitRepository,
    tenant_id: &TenantId,
