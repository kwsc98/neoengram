...
/// The single current public API and Agent wire versions.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, SensitiveFields)]
#[serde(deny_unknown_fields)]
...
/// mount. This is intentionally separate from approval so a replacement can never reopen a
/// Volume before its mount observation has been validated.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, SensitiveFields)]
#[serde(deny_unknown_fields)]
#[sensitive(opaque)]
pub struct CompleteStorageRecoveryRequest {
    pub tenant_id: String,
    pub storage_enrollment_id: String,
    pub expected_resource_version: String,
...
pub struct StorageVolumeView {
    ...
    pub max_whole_file_bytes: String,
    pub copy_reserve_bytes: String,
    #[serde(skip_serializing_if = "Option::is_none")]
...
mod tests {
    ...
    #[test]
    fn create_request_rejects_unknown_root_members() {
