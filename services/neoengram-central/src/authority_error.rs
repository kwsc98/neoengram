...
use neoengram_domain::protocol::ProtocolError;
...
pub enum CentralErrorCode {
    ...
    StorageVolumeNotReady,
    SnapshotDeliveryUnavailable,
    SnapshotDeliveryUnsupported,
    StorageVolumeRegionMismatch,
    JobNotFound,
    JobAlreadyExists,
    JobIdReused,
    ReplicationAlreadyActive,
    ReplicationRetryRequestReused,
    InvalidState,
    AssignmentMismatch,
    GenerationMismatch,
    DeadlineExceeded,
...
impl CentralErrorCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::StorageVolumeNotReady => "STORAGE_VOLUME_NOT_READY",
            Self::SnapshotDeliveryUnavailable => "SNAPSHOT_DELIVERY_UNAVAILABLE",
            Self::SnapshotDeliveryUnsupported => "SNAPSHOT_DELIVERY_UNSUPPORTED",
            Self::StorageVolumeRegionMismatch => "STORAGE_VOLUME_REGION_MISMATCH",
            Self::JobNotFound => "JOB_NOT_FOUND",
            Self::JobAlreadyExists => "JOB_ALREADY_EXISTS",
            Self::JobIdReused => "JOB_ID_REUSED",
            Self::ReplicationAlreadyActive => "REPLICATION_ALREADY_ACTIVE",
            Self::ReplicationRetryRequestReused => "REPLICATION_RETRY_REQUEST_ID_REUSED",
