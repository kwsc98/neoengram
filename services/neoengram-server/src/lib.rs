...
pub use service::{
    ...
    StorageAvailabilityProvider, SystemService, WorkloadCertificateIssuance,
    WorkloadCertificateIssuer, WorkloadCertificateIssuerError, WorkloadCertificateRequest,
    WorkloadCertificateUsage, WorkloadIdentity, WorkloadIdentityUri, WorkloadPkiError,
    WorkspaceCommitResult, WorkspaceCommitService, DEFAULT_CENTRAL_COMMAND_TTL_MS,
