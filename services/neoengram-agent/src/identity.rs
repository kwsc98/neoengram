...
use neoengram_domain::protocol::{AgentId, Ed25519PublicKeySpki, TenantId};
use ring::{
    rand::SystemRandom,
        ...
        let queued = queue
            .enqueue(
                AgentReport::Accepted(JobAccepted {
                    ...
                    request_digest: neoengram_domain::protocol::ContentDigest::hash(
                        b"assignment-a",
                    ),
