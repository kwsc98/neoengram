...
export const gatewayPools: GatewayPoolView[] = [
  {
    gateway_pool_id: 'pool-cn-east-1',
    edge_cluster_id: 'cluster-cn-east-1',
    display_name: '华东 Gateway',
    agent_endpoint: 'https://gateway-east.example.test:8181',
    s3_endpoint: 'https://s3-east.example.test',
    desired_replicas: 2,
  ...
  {
    gateway_pool_id: 'pool-cn-north-1',
    edge_cluster_id: 'cluster-cn-north-1',
    display_name: '华北 Gateway',
    agent_endpoint: 'https://gateway-north.example.test:8181',
    s3_endpoint: 'https://s3-north.example.test',
    desired_replicas: 1,
    minimum_ready_replicas: 1,
    state: 'ready',
    config_generation: '2',
  ...
  {
    gateway_pool_id: 'pool-cn-south-1',
    edge_cluster_id: 'cluster-cn-south-1',
    display_name: '华南 Gateway',
    agent_endpoint: 'https://gateway-south.example.test:8181',
    s3_endpoint: 'https://s3-south.example.test',
    desired_replicas: 2,
    minimum_ready_replicas: 1,
    state: 'ready',
    config_generation: '4',
...
export const snapshots: SnapshotView[] = [
  ...
  },
  {
    ...
    artifact_id: 'road-scenes',
    commit_id: mockCommitIds.roadMain3,
    delivery_id: 'delivery-road-main3-gz-01',
    storage_volume_id: 'volume-guangzhou-delivery',
    edge_cluster_id: 'cluster-cn-south-1',
    delivery_mode: 'copy',
    data_layout: 'fast_cdc',
  ...
  },
  {
    ...
    artifact_id: 'dialog-corpus',
    commit_id: mockCommitIds.dialog2,
    delivery_id: 'delivery-dialog-2-bj-01',
    storage_volume_id: 'volume-beijing-language',
    edge_cluster_id: 'cluster-cn-north-1',
    delivery_mode: 'copy',
    data_layout: 'fast_cdc',
  ...
  },
  {
    ...
    artifact_id: 'release-assets',
    commit_id: mockCommitIds.release1,
    delivery_id: 'delivery-release-1-sha-01',
    storage_volume_id: 'volume-release',
    edge_cluster_id: 'cluster-cn-east-1',
